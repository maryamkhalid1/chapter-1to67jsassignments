...
// // 3
// var student = ["Tooba", "Aqsa", "Fatima", "Iffat", "Maryum", "Kiran", "Tehmina"];
...
// // 6
// var mixed = ["Maryum", 53, "Khalid", true];
...
// // Assignment # 17-20
// // 1
// var student = [["Maryum",22],["Tooba",23]["Tehmina",23]];
...
//var customerName = "Maryum Khalid";
//var today = new Date();
//mlist = [ "January", "Febmliruary", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" ];
...
document.getElementById('first-name').value = 'Maryum';

//// v. Repeat part iv for id ”last-name” and “email”.

document.getElementById('last-name').value = 'Khalid';

document.getElementById('emaill').value = 'mk267567@gmail.com';
